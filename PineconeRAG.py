...
os.environ["PINECONE_API_KEY"] = "1f4102d9-01c8-42ef-bf8b-72c0ee2518b5"
...
def loadText():
    ...
    pc = Pinecone(api_key='1f4102d9-01c8-42ef-bf8b-72c0ee2518b5')
...
def search():
    ...
    query = "King. How is it the clouds still on you?"
